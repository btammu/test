#!/bin/bash
token=$(curl -v -i -u $user1:$pass1 -X POST 'https://budda-tammu.atlassian.net/rest/api/2/myself' --header 'Authorization: Basic $newtoken' --header 'Accept:application/json' --header 'Content-Type: application/json')
